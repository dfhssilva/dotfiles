...
local WIDGET_DIR = HOME .. "/.config/awesome/modules/battery-widget"
	...
	local function show_battery_status(batteryType)
		...
		elseif battery_backend == "upower" then
			awful.spawn.easy_async({
				awful.util.shell,
				"-c",
				[[ upower -i $(upower -e | grep BAT) | awk '{ if ($1 == "native-path:") {print $2} else if ($1 == "percentage:") {print $2} else if ($1 == "state:") {print $2} else if ($1 == "time") {print $4" "$5} }' ]],
